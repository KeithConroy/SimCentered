...
ActiveRecord::Schema.define(version: 20160329020209) do
  ...
  add_index "room_groups", ["organization_id"], name: "index_room_groups_on_organization_id"

  create_table "room_groups_rooms", id: false, force: :cascade do |t|
